...
public class QueryParser {
     ...
     * @return
     */
    private static QueryData<Float> extractPrice(String query) {
        try {
    ...
    private static QueryData<Float> extractArea(String query) {
        try {
            List<Float> result = new ArrayList<>();
    ...
    private static QueryData<Integer> extractBedroom(String query) {
        try {
    ...
    private static QueryData<Integer> extractToilet(String query) {
        try {
            List<Integer> result = new ArrayList<>();
    ...
    private static QueryData<Integer> extractFloor(String query) {
        try {
            List<Integer> result = new ArrayList<>();
...
//        String q = " mua nha rieng gia 1.3-2,5 ty dien tich 20,33 -30.33 m2 co 3-40 phong ngu 7 vs 5-6 tang";
        String q = "nhà riêng 32m2 giá nho hon 2 tỷ 2pn 3vs tại linh đàm";
